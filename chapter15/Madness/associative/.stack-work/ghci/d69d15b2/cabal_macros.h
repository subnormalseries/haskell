...
/* package associative-0.1.0.0 */
#ifndef VERSION_associative
#define VERSION_associative "0.1.0.0"
#endif /* VERSION_associative */
#ifndef MIN_VERSION_associative
#define MIN_VERSION_associative(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_associative */
...
#define CURRENT_COMPONENT_ID "associative-0.1.0.0-3DsvFuqwg0eISZBwAyQjC6-associative"
